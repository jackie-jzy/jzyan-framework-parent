package org.jzyan.framework.core.aspect;
...
import org.jzyan.framework.core.annotation.SignVerify;
import org.jzyan.framework.core.enums.ResCodeEnum;
import org.jzyan.framework.core.response.CommonRes;
import org.jzyan.framework.core.utils.SignUtils;
...
public class SignVerifyAspect implements EnvironmentAware {
    ...
    @Around("@annotation(org.jzyan.framework.core.annotation.SignVerify)")
    public Object handleSignVerify(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (SignUtils.verifySignature(this.environment.resolvePlaceholders(annotation.value()), map)) {
            return joinPoint.proceed();
        }
        return CommonRes.failed(ResCodeEnum.CODE_400);
